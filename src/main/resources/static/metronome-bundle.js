...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Howl = __webpack_require__(158);
	var Metronome = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'button',
	                { type: 'button', onClick: this.handleDecrement },
	                ' - '
	            ),
	            React.createElement('input', { type: 'number', value: this.state.tempo, onChange: this.handleChange }),
	            React.createElement(
	                'button',
	                { type: 'button', onClick: this.handleIncrement },
	                ' + '
	            ),
	            React.createElement('hr', null),
	            React.createElement(ButtonContainer, { tempo: this.state.tempo })
	        );
	    }
	...
	var ButtonContainer = React.createClass({
	    ...
	    handleStartClick: function handleStartClick() {
	        var audio = new Audio('/src/main/js/MetroBeat1.wav');
	...
	React.render(React.createElement(Metronome, null), document.getElementById('gnome'));
